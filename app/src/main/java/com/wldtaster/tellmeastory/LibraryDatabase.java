...
public class LibraryDatabase extends SQLiteAssetHelper {
    private static final String TAG = SQLiteAssetHelper.class.getSimpleName(); /**Create a TAG for the Log data*/
    private static final String DATABASE_NAME = Constants.LibraryDatabaseName ; /**Set the name of the database which contains the HK Stories data*/
    private static final int DATABASE_VERSION = Constants.LibraryVersion; /** Set the version of the database*/
